...
%         end
        ...
        if isempty(tau2) || t>tau2(end, 1)
            tau2 = [tau2; [t d2_bar*v2+h2_bar+phi2_bar]];
        end
    end
    ...
    dydt(2, 1) = v2;
    dydt(3, 1) = y(4, 1);
    dydt(4, 1) = -(h1+phi1+d12*v2)/d11;
    
    if isempty(q1_ddot) || t>q1_ddot(end, 1)
        q1_ddot = [q1_ddot; [t dydt(4, 1)]];
    end
    if isempty(q2_ddot) || t>q2_ddot(end, 1)
        q2_ddot = [q2_ddot; [t dydt(2, 1)]];
    end
end